class HistoryDetailModel {
  ...
  HistoryDetailModel({required this.invoice, required this.idUser, required this.orderAt, required this.status, required this.detail});

  factory HistoryDetailModel.fromJson(Map<String, dynamic> dataOrder) {
